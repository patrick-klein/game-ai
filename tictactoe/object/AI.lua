...
function AI:updateConstants()
	...
	self.eps = self.eps_initial+(self.eps_final-self.eps_final)*(self.loopCount/self.numLoops)
	self.gamma = self.gamma_initial+(self.gamma_final-self.gamma_final)*(self.loopCount/self.numLoops)
	self.learnRate = self.learnRate_initial+(self.learnRate_final-self.learnRate_final)*(self.loopCount/self.numLoops)
	self.alpha = self.alpha_initial+(self.alpha_final-self.alpha_final)*(self.loopCount/self.numLoops)
